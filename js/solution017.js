...
saturday = [5448, 8041, 6573, 8104, 6208, 5912, 7927, 8909, 7000, 5059, 6412, 6354, 8943, 5460, 9979, 5379, 8501, 6831, 7022, 7575, 5828, 5354, 5115, 9625,7795, 7003, 5524, 9870, 6591, 8616, 5163, 6656, 8150, 8826, 6875, 5242, 9585, 9649,9838, 
7150, 6567, 8524, 7613, 7809, 5562, 7799, 7179, 5184, 7960, 9455, 5633, 9085];

const sumWithInitial = saturday.reduce(
...
let sumWeeks = []
stairs.forEach((element, index) => {
   
    sumWeeks[index] = element.reduce(
        (previousValue, currentValue) => previousValue + currentValue,
        0
      );
});
const finalAnswer = sumWeeks.reduce((pV,cV) => 
    pV + cV,0
);

console.log(finalAnswer * 20)
